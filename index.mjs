...
//   console.log(`Starting Rock, Paper, Scicssors! as ${who}`);
//   let acc = null;
...
//   }else{
//     const sercet = await ask(
//       `What is your account secret`,
//       (x => x)
//     );
//     acc = await stdlib.newAccountFromSecret(sercet);
//   }
...
//     const hand = await ask(`What hand will you play?`,
//     (x) => {
//       const hand = HANDS[x];
//       if(hand == null) {
